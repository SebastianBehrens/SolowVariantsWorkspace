# Extended Solow Growth Model — Scarce Resources — Oil and Land =================================
...
ESSROL_aux_data <- reactive({
    SimulateExtendedSolowModelScarceResourceOilAndLand(ESSROL_parametergrid_debounced(), input$ESSROL_nperiods_selected,
                                                       list(
