...
# sectiontitle ---------------------------------
numericInput("ComparingModels1_ESSROL_parameterchange_valuebefore_alpha", "Alpha", 2/5, step = 0.05),
...
hr(),
# sectiontitle ---------------------------------
numericInput("ComparingModels1_ESSROL_parameterchange_valuebefore_beta", "Beta", 2/5, step = 0.05),
...
hr(),
# sectiontitle ---------------------------------
numericInput("ComparingModels1_ESSROL_parameterchange_valuebefore_kappa", "Kappa", 2/5, step = 0.05),
