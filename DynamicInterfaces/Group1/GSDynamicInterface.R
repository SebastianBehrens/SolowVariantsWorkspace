GSDynamicInterface <- conditionalPanel(condition = "input.ComparingModels1_VariantSelection1 == 'GS'",
                                       # Starting Values ---------------------------------
                                       titlePanel("Starting Values of Stocks"),
                                       # StartingValuesCodeAutoFillLineIndexer
                                       numericInput("ComparingModels1_GS_initval_A", "Initial Value of TFP", 5),
                                       numericInput("ComparingModels1_GS_initval_K", "Initial Value of Capital", 5),
                                       numericInput("ComparingModels1_GS_initval_L", "Initial Value of Labor", 5),
