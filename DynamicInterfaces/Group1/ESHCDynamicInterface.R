...
# sectiontitle ---------------------------------
numericInput("ComparingModels1_ESHC_parameterchange_valuebefore_alpha", "Alpha", 1/3, step = 0.05),
...
hr(),
# sectiontitle ---------------------------------
numericInput("ComparingModels1_ESHC_parameterchange_valuebefore_phi", "Phi", 1/6, step = 0.05),
