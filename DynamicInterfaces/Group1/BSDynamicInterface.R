BSDynamicInterface <- conditionalPanel(condition = "input.ComparingModels1_VariantSelection1 == 'BS'",
                                       # Starting Values ---------------------------------
                                       titlePanel("Starting Values of Stocks"),
                                       # StartingValuesCodeAutoFillLineIndexer
                                       numericInput("ComparingModels1_BS_initval_K", "Initial Value of Capital", 5),
                                       numericInput("ComparingModels1_BS_initval_L", "Initial Value of Labor", 5),
