...
# sectiontitle ---------------------------------
numericInput("ComparingModels2_ESSRL_parameterchange_valuebefore_alpha", "Alpha", 2/5, step = 0.05),
...
hr(),
# sectiontitle ---------------------------------
numericInput("ComparingModels2_ESSRL_parameterchange_valuebefore_beta", "Beta", 2/5, step = 0.05),
